...
# Web camera
cap = cv2.VideoCapture('vehical_counter.mp4')
...
# Set minimum and maximum area thresholds to filter out small contours
min_area = 500
max_area = 10000
...
while True:
    ...
    for (i, c) in enumerate(counterSahpe):
        ...
        # Check if contour area is within the defined thresholds
